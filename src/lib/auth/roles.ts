...
export const routeRoles: Array<{ pattern: RegExp; roles: Role[] }> = [
  { pattern: /^\/admin/, roles: [Role.SUPER_ADMIN, Role.VC, Role.IT] },
  ...
  { pattern: /^\/settings/, roles: [Role.SUPER_ADMIN, Role.IT] },
  { pattern: /^\/rep/, roles: [Role.CLASS_REP] },
  { pattern: /^\/dashboard/, roles: [Role.SUPER_ADMIN, Role.QA_OFFICER, Role.QA_ASSISTANT, Role.IT, Role.HOD, Role.HOD_ASSISTANT] }
];
